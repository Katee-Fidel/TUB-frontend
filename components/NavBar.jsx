...
export default function NavBar() {
  ...
  return (
    <nav className="relative flex items-center justify-between py-4 sm:py-5 border-b border-white/10">
      ...
      <button type="button" aria-label={open ? "Close navigation menu" : "Open navigation menu"} aria-expanded={open} onClick={() => setOpen((value) => !value)} className="sm:hidden flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-ivory hover:bg-white/5 transition">
