...
export const api = {
  ...
  getTopupStatus: (id) => request(`/api/wallet/topup/${id}/status`, { method: 'GET' }),
  contributeSavings: (eventId, amount) => request('/api/wallet/savings/contribute', { method: 'POST', body: JSON.stringify({ eventId, amount }) }),
  refundTicket: (ticketId) => request(`/api/wallet/refund/${ticketId}`, { method: 'POST' }),
